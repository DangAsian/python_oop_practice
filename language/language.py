...
class MathGenius(Multilinguist):
    ...
    def report_total(self, array):
        total = 0
        for num in array:
            total += num

        language = self.say_in_local_language("The total is {}".format(total))
        return language
...
me1 = QuoteCollector()
print(me1.quotes)
print(me1.add_quotes("Hello"))
print(me1.add_quotes("Bye"))
print(me1.quotes)
print(me1.random())
